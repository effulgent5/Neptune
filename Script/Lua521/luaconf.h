...
/*
@@ SCRIPT_EI is a mark for all core API functions.
...
*/
#ifndef SCRIPT_IMPORT
	#ifdef SCRIPT_EXPORT
		#define SCRIPT_EI __declspec(dllexport)
	#else
		#define SCRIPT_EI __declspec(dllimport)
	#endif
#endif


/* more often than not the libs go together with the core */
#define LUALIB_API	SCRIPT_EI
